...
exports.login = exports.getMenuId = exports.getMenu = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 5;
            return connection.query('SELECT * FROM pizza');
...
var getMenuId = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return connection.query("SELECT * FROM tablaEjemplo1 WHERE id = ? ", [req.params.id]);
  ...
  return function getMenuId(_x3, _x4) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return connection.query("SELECT * FROM tablaEjemplo1 WHERE user = ? and  pass = ? ", [req.boby.user, req.boby.pass]);
